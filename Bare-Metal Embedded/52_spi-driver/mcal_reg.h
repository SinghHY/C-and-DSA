...
namespace mcal{
   ...
   namespace reg{
      ...
      const std::uint32_t rcc_base        = ahb1periph_base + 0x00003800U;
		 	...
		 	const std::uint32_t apb1periph_base = periph_base ;
      ...
      const std::uint32_t uart2_base      = 0x40004400;
			...
			const std::uint32_t i2c1_base  = apb1periph_base + 0x5400U;
			const std::uint32_t i2c2_base  = apb1periph_base + 0x5800U;
			const std::uint32_t i2c3_base  = apb1periph_base + 0x5C00U;
			
			const std::uint32_t spi1_base  = 0x40013000U;
			const std::uint32_t spi2_base  = 0x40003800U;
			const std::uint32_t spi3_base  = 0x40003C00U;
			const std::uint32_t spi4_base  = 0x40013400U;
			const std::uint32_t spi5_base  = 0x40015000U;
      ...
      const std::uint32_t gpiog_afrh      = gpiog_base      +  afrh_offset;  
       ...
       const 	 std::uint32_t  adc1_sr = 		adc_sr_offset    + adc1_base;
			...
			//I2C Registers
				const std::uint32_t   i2c_cr1_offset     = 0x00;
				const std::uint32_t   i2c_cr2_offset     = 0x04;
				const std::uint32_t   i2c_oar1_offset    = 0x08;
		    const std::uint32_t   i2c_oar2_offset    = 0x0C;
		    const std::uint32_t   i2c_dr_offset    	 = 0x10;
		    const std::uint32_t   i2c_sr1_offset     = 0x14;
		    const std::uint32_t   i2c_sr2_offset     = 0x18;

		    const std::uint32_t   i2c_ccr_offset     = 0x1C;
		    const std::uint32_t   i2c_trise_offset   = 0x20;
		    const std::uint32_t   i2c_fltr_offset    = 0x24;
			
			 //I2C1
				const 	 std::uint32_t  i2c1_cr1 		=  i2c1_base + i2c_cr1_offset;
				const 	 std::uint32_t  i2c1_cr2 		=  i2c1_base + i2c_cr2_offset;
				const 	 std::uint32_t  i2c1_oar1 	=  i2c1_base + i2c_oar1_offset;
				const 	 std::uint32_t  i2c1_oar2 	=  i2c1_base + i2c_oar2_offset;
				const 	 std::uint32_t  i2c1_dr 		=  i2c1_base + i2c_dr_offset;
				const 	 std::uint32_t  i2c1_sr1 		=  i2c1_base + i2c_sr1_offset;
				const 	 std::uint32_t  i2c1_sr2 		=  i2c1_base + i2c_sr2_offset;
				const 	 std::uint32_t  i2c1_ccr 		=  i2c1_base + i2c_ccr_offset;
				const 	 std::uint32_t  i2c1_trise	=  i2c1_base + i2c_trise_offset;
				const 	 std::uint32_t  i2c1_fltr 	=  i2c1_base + i2c_fltr_offset;
				
				 //I2C2
				const 	 std::uint32_t  i2c2_cr1 		=  i2c2_base + i2c_cr1_offset;
				const 	 std::uint32_t  i2c2_cr2 		=  i2c2_base + i2c_cr2_offset;
				const 	 std::uint32_t  i2c2_oar1 	=  i2c2_base + i2c_oar1_offset;
				const 	 std::uint32_t  i2c2_oar2 	=  i2c2_base + i2c_oar2_offset;
				const 	 std::uint32_t  i2c2_dr 		=  i2c2_base + i2c_dr_offset;
				const 	 std::uint32_t  i2c2_sr1 		=  i2c2_base + i2c_sr1_offset;
				const 	 std::uint32_t  i2c2_sr2 		=  i2c2_base + i2c_sr2_offset;
				const 	 std::uint32_t  i2c2_ccr 		=  i2c2_base + i2c_ccr_offset;
				const 	 std::uint32_t  i2c2_trise	=  i2c2_base + i2c_trise_offset;
				const 	 std::uint32_t  i2c2_fltr 	=  i2c2_base + i2c_fltr_offset;
				
				//I2C3
				const 	 std::uint32_t  i2c3_cr1 		=  i2c3_base + i2c_cr1_offset;
				const 	 std::uint32_t  i2c3_cr2 		=  i2c3_base + i2c_cr2_offset;
				const 	 std::uint32_t  i2c3_oar1 	=  i2c3_base + i2c_oar1_offset;
				const 	 std::uint32_t  i2c3_oar2 	=  i2c3_base + i2c_oar2_offset;
				const 	 std::uint32_t  i2c3_dr 		=  i2c3_base + i2c_dr_offset;
				const 	 std::uint32_t  i2c3_sr1 		=  i2c3_base + i2c_sr1_offset;
				const 	 std::uint32_t  i2c3_sr2 		=  i2c3_base + i2c_sr2_offset;
				const 	 std::uint32_t  i2c3_ccr 		=  i2c3_base + i2c_ccr_offset;
				const 	 std::uint32_t  i2c3_trise	=  i2c3_base + i2c_trise_offset;
				const 	 std::uint32_t  i2c3_fltr 	=  i2c3_base + i2c_fltr_offset;
			...
			typedef struct
			{
				...
				volatile std::uint32_t OAR1;       /*!< I2C Own address register 1, Address offset: 0x08 */
				volatile std::uint32_t OAR2;       /*!< I2C Own address register 2, Address offset: 0x0C */
				volatile std::uint32_t DR;         /*!< I2C Data register,          Address offset: 0x10 */
				volatile std::uint32_t SR1;        /*!< I2C Status register 1,      Address offset: 0x14 */
				volatile std::uint32_t SR2;        /*!< I2C Status register 2,      Address offset: 0x18 */
				volatile std::uint32_t CCR;        /*!< I2C Clock control register, Address offset: 0x1C */
				volatile std::uint32_t TRISE;      /*!< I2C TRISE register,         Address offset: 0x20 */
				volatile std::uint32_t FLTR;       /*!< I2C FLTR register,          Address offset: 0x24 */
			} I2C_TypeDef;
      ...
      //SPI Registers
			...
			const std::uint32_t   spi_cr1_offset         = 0x00;
			const std::uint32_t   spi_cr2_offset         = 0x04;
			const std::uint32_t   spi_sr_offset          = 0x08;
			const std::uint32_t   spi_dr_offset          = 0x0C;
			const std::uint32_t   spi_crcpr_offset       = 0x10;
			const std::uint32_t   spi_rxcrcr_offset      = 0x14;
			const std::uint32_t   spi_txcrcr_offset      = 0x18;
			const std::uint32_t   spi_i2scfcr_offset     = 0x1C;
			const std::uint32_t   spi_i2spr_offset     	 = 0x20;
			
			//SPI1
			const std::uint32_t  spi1_cr1 			=  spi1_base + spi_cr1_offset;
			const std::uint32_t  spi1_cr2 			=  spi1_base + spi_cr2_offset;
			const std::uint32_t  spi1_sr 				=  spi1_base + spi_sr_offset;
			const std::uint32_t  spi1_dr 				=  spi1_base + spi_dr_offset;
			const std::uint32_t  spi1_crcpr 		=  spi1_base + spi_crcpr_offset;
			const std::uint32_t  spi1_rxcrcr 		=  spi1_base + spi_rxcrcr_offset;
			const std::uint32_t  spi1_txcrcr 		=  spi1_base + spi_txcrcr_offset;
			const std::uint32_t  spi1_i2scfcr 	=  spi1_base + spi_i2scfcr_offset;
			const std::uint32_t  spi1_i2spr 		=  spi1_base + spi_i2spr_offset;
			
			typedef struct
			{
				volatile std::uint32_t CR1;        /*!< SPI control register 1 (not used in I2S mode),      Address offset: 0x00 */
				volatile std::uint32_t CR2;        /*!< SPI control register 2,                             Address offset: 0x04 */
				volatile std::uint32_t SR;         /*!< SPI status register,                                Address offset: 0x08 */
				volatile std::uint32_t DR;         /*!< SPI data register,                                  Address offset: 0x0C */
				volatile std::uint32_t CRCPR;      /*!< SPI CRC polynomial register (not used in I2S mode), Address offset: 0x10 */
				volatile std::uint32_t RXCRCR;     /*!< SPI RX CRC register (not used in I2S mode),         Address offset: 0x14 */
				volatile std::uint32_t TXCRCR;     /*!< SPI TX CRC register (not used in I2S mode),         Address offset: 0x18 */
				volatile std::uint32_t I2SCFGR;    /*!< SPI_I2S configuration register,                     Address offset: 0x1C */
				volatile std::uint32_t I2SPR;      /*!< SPI_I2S prescaler register,                         Address offset: 0x20 */
			} SPI_TypeDef;
