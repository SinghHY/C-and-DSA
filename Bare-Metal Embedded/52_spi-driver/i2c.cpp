...
#define I2C2 ((mcal::reg::I2C_TypeDef*)mcal::reg::i2c2_base)
#define I2C3 ((mcal::reg::I2C_TypeDef*)mcal::reg::i2c3_base)
...
void i2c_ds1307_rtc_Init(void){
 ...
 mcal::reg::reg_access<std::uint32_t,std::uint32_t,mcal::reg::apb1enr,(1U<<21)>::reg_or();
	...
	mcal::reg::reg_access<std::uint32_t,std::uint32_t,mcal::reg::gpiob_moder,(1U<<16)>::reg_not();
	mcal::reg::reg_access<std::uint32_t,std::uint32_t,mcal::reg::gpiob_moder,(1U<<17)>::reg_or();

	//Set PB9 as alternate function pin
	mcal::reg::reg_access<std::uint32_t,std::uint32_t,mcal::reg::gpiob_moder,(1U<<18)>::reg_not();
 ...
 //Set pins to pull-up
   ...
   /*I2C Configuration*/
	 ...
	 /*Software reset i2c1*/
	mcal::reg::reg_access<std::uint32_t,std::uint32_t,mcal::reg::i2c1_cr1,(0x8000)>::reg_set();
