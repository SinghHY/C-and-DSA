...
namespace mcal{
   ...
   namespace reg{
      ...
      const std::uint32_t uart2_base      = 0x40004400;
		  ...
		  const std::uint32_t tim3_base = 0x40000400U;
	   ...
	   //USART Registers
        ...
        const std::uint32_t val_offset 				    =  0x008;
		  ...
		  const std::uint32_t tim2_cr4 					=  tim_cr4_offset + tim2_base; 
			...
			const std::uint32_t tim3_smcr 				=  tim2_smcr_offset + tim3_base;
		  const std::uint32_t tim3_dier 				=  tim2_dier_offset + tim3_base;

		  const std::uint32_t tim3_sr				    =  tim2_sr_offset + tim3_base;
			const std::uint32_t tim3_egr					=  tim2_egr_offset+ tim3_base;
			
			const std::uint32_t tim3_ccmr1				=  tim2_ccmr1_offset + tim3_base;

			const std::uint32_t tim3_ccmr2				=  tim2_ccmr2_offset + tim3_base;
			const std::uint32_t tim3_ccer				  =  tim2_ccer_offset + tim3_base;
			
			
			const std::uint32_t tim3_psc 					=  tim_psc_offset + tim3_base;
			const std::uint32_t tim3_arr 					=  tim_arr_offset + tim3_base;
		  const std::uint32_t tim3_cnt					=  tim_cnt_offset + tim3_base;
			
		  const std::uint32_t tim3_cr1 					=  tim_cr1_offset + tim3_base;
		  const std::uint32_t tim3_cr2 					=  tim_cr2_offset + tim3_base; 
		  const std::uint32_t tim3_cr3 					=  tim_cr3_offset + tim3_base; 
		  const std::uint32_t tim3_cr4 					=  tim_cr4_offset + tim3_base; 
